...
data_entry_raw = DataFrame(project_entry.export_records(fields=['redcap_event_name', 'dob', 'sex',
                                                                'exclude', 'visit_ignore', 'visit_date',
                                                                'visit_ignore_why', 'visit_ignore_why_other',
                                                                'visit_notes', 'np_notes', 'clin_notes', 'mri_t1_date',
                                                                'mri_dti_date', 'mri_rsfmri_date', 'mri_xnat_sid',
                                                                'mri_xnat_eids']))
...
baseline = baseline.rename(columns={'redcap_event_name': 'baseline', 'visit_date': 'baseline_date',
                                    'visit_ignore___yes': 'baseline_ignore'})
...
Month6 = Month6.rename(columns={'redcap_event_name': 'Month6', 'visit_date': 'Month6_date',
                                'visit_ignore___yes': 'Month6_ignore'})

#year1
year1_raw = data_entry_raw.loc[data_entry_raw['redcap_event_name'] == "1y visit (Arm 1: Standard Protocol)"]
year1 = year1_raw[['study_id', 'redcap_event_name', 'visit_date', 'visit_ignore___yes', 'visit_ignore_why',
                   'visit_ignore_why_other', 'visit_notes', 'np_notes', 'clin_notes', 'mri_t1_date', 'mri_dti_date',
                   'mri_rsfmri_date', 'mri_xnat_sid', 'mri_xnat_eids']]
...
Month18 = Month18.rename(columns={'redcap_event_name': 'Month18', 'visit_date': 'Month18_date',
                                  'visit_ignore___yes': 'Month18_ignore'})

#year2
year2_raw = data_entry_raw.loc[data_entry_raw['redcap_event_name'] == "2y visit (Arm 1: Standard Protocol)"]
year2 = year2_raw[['study_id', 'redcap_event_name', 'visit_date', 'visit_ignore___yes', 'visit_ignore_why',
                   'visit_ignore_why_other', 'visit_notes', 'np_notes', 'clin_notes', 'mri_t1_date', 'mri_dti_date',
                   'mri_rsfmri_date', 'mri_xnat_sid', 'mri_xnat_eids']]
