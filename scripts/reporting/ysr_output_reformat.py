...
excel =pandas.ExcelFile('ysr_june2017.xlsx')
data = excel.parse("YSR_11_18")


today=time.strftime("%m%d%Y")
myfile_name='ysr_outcome_reformate_'+today+'.csv'
data = data.rename(columns={ 'Anxious__Depressed_Total':'ysr_anxdep_raw',
...
colnames_out=['subject','arm','visit','Age','ysr_firstname']+colnames2out
