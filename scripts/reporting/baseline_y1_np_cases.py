...
Usage:
python baseline_y1_np_cases.py
"""
...
def main(args=None):
    ...
    results.to_csv(os.path.join(args.csvdir, args.outfile),
                   columns = ['exclude','visit_ignore___yes', 'mri_xnat_sid','mri_xnat_eids'])
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(prog="baseline_yr1_np_cases.py",
                                     description=__doc__,
